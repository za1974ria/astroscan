...
| Métrique | Valeur |
|----------|--------|
| Lignes totales | 9 731 (après PASS 10) |
| `@app.route` actifs | **75** |
| `# MIGRATED TO` markers (migrés) | 161 |
...
### Progression
- Routes migrées : **188 / 269** ≈ **70%**
- Routes restantes dans monolithe : **75 actives** (−13 vs PASS 9)
