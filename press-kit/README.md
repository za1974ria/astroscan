# 📰 ASTRO-SCAN — Press Kit

**For journalists, institutional partners, and research collaborators.**

*Pour les journalistes, partenaires institutionnels, et collaborateurs scientifiques.*

---

## 🎯 Quick Facts · Faits saillants

| | |
|---|---|
| **Project name** | ASTRO-SCAN |
...
| **Stack** | Flask 3.1 · Python 3.12 · SQLite · Cesium · Nginx |
| **Architecture** | 25 blueprints · 266 routes · 13 services |
| **Visitors** | 2,195+ unique humans (deduplicated) |
| **Reach** | 49+ countries |
| **Languages** | French · English (bilingual UI, hreflang sitemap) |
| **Contact** | zakaria.chohra@gmail.com |
...
- **[screenshots/](./screenshots/)** — High-resolution screenshots
...
For interview requests, custom imagery, or institutional partnership inquiries: include a one-line subject prefix `[PRESS]` or `[INSTITUTION]` for fastest response.

---

*Press kit last updated: 2026-05-04 · Pass 31*
