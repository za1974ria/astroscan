    ...
    try:
        ...
        if not row:
            ...
            content += (
                "─── SOURCE ───────────────────────────────────────────────\n"
                f"{source_text}\n"
                "Agrégateur : Open-Meteo (https://open-meteo.com)\n"
                "Modèles utilisés : ECMWF IFS, NOAA GFS, DWD ICON, Météo France ARPEGE\n\n"
                "─── INCERTITUDES TYPIQUES (modèles globaux) ──────────────\n"
                "Température : ± 1 à 2 °C\n"
                "Pression    : ± 2 hPa\n"
                "Vent        : ± 2 à 3 km/h (intensité), ± 20° (direction)\n"
                "Humidité    : ± 5 à 10 %\n"
                "Visibilité  : ± 5 km (selon couverture nuageuse)\n\n"
                "Note : ces marges d'erreur sont des ordres de grandeur\n"
                "classiques pour les modèles atmosphériques globaux à\n"
                "résolution moyenne (~9-25 km). Pour une précision locale\n"
                "supérieure, une station d'observation physique au sol est\n"
                "nécessaire.\n\n"
                "═══════════════════════════════════════════════════════════\n"
